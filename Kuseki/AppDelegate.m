...
- (void)application:(UIApplication *)application
  ...
  //保存中の検索条件一覧をDBから取得
  KUSearchConditionManager *conditionManager =
...
- (void)application:(UIApplication *)application
  ...
  NSLog(@"空席情報が変化しました");
  UIAlertView *al =
      [[UIAlertView alloc] initWithTitle:@"空席状況が変化しました"
...
+ (void)showAlertWithTitle:(NSString *)title
                ...
                completion:(KUAlertCompetion)completion {
...
- (void)addNotification:(NSString *)body
...
- (void)savedResponseManager:(id)manager
    DidFinishLoadingResponses:(NSArray *)responses {
  //通知対象の空席情報と、最新の空席情報で差異がある場合には再情報をKUDifferenceとして格納
  KUDifferencesManager *diffManager = [KUDifferencesManager sharedManager];
  KUNotificationTargetsManager *targetsManager =
